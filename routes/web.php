...
Route::group(['middleware' => ['auth']], function () {
    ...
    //投稿の編集ページのURLへのアクセスが有った時の処理。
    //Route::get('messages/{id}/edit', 'MessagesController@edit')->name('messages.edit'); //投稿の編集。まずは投稿の編集から。2022.08.17..1135TKT
    ...
    //Route::get('profile/{id}/edit', 'ProfileController@edit')->name('profile.edit'); //プロフィールの編集                                                                                             //| DELETE   | microgeniuses/{microgenius}   | microgeniuses.destroy | App\Http\Controllers\MicrogeniusesController@destroy              | web,auth     |
